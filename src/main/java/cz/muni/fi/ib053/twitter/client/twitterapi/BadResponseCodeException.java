...
/**
 * Thrown when bad response code was returned. Other than 200 should not be accepted
 *
 * @author Wallecnik
 * @version 1.0
 */
public class BadResponseCodeException extends Exception {
     ...
     * @since 1.7
     */
    public BadResponseCodeException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
