...
//std::string HttpNative_httpRequest(const_old_string method, const_old_string protocol, const_old_string jpath, const_old_string host, const_old_string usetAgent, const_old_string autorization, const_old_string content);
...
JNIEXPORT jstring JNICALL Java_cz_muni_fi_ib053_twitter_client_twitterapi_HttpNative_httpRequest
  (JNIEnv *env, jclass obj, jstring jstr_method, jstring jstr_protocol, jstring jstr_path, jstring jstr_host, jstring jstr_usetAgent, jstring jstr_autorization, jstring jstr_content){
    ...
    std::string ret_val;
    ret_val = HttpNative_httpRequest(str_method, str_protocol, str_path, str_host, str_usetAgent, str_autorization, str_content);
 ...
 */
std::string HttpNative_httpRequest(const_old_string str_method, const_old_string str_protocol, const_old_string str_path, const_old_string str_host, const_old_string str_usetAgent, const_old_string str_autorization, const_old_string str_content){
    CURL * curl;
    CURLcode res;
    std::string ret_val;
